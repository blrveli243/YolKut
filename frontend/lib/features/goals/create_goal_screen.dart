  ...
  void _saveGoal() async {
    if (_titleController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Lütfen hedef ve görev adını girin.')),
      );
      return;
    }
    ...
    try {
      ...
      ref
          ...
          .fetchTasksForDate(ref.read(tasksProvider).selectedDate);
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isSelected ? AppColors.info : Theme.of(context).cardColor,
